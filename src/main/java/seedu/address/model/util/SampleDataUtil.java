    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            ...
            new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                    new Telegram("FishyBernice"), new Event("Charity Gala"), new Role("Finance Secretary"),
                     getSkillSet("JavaScript", "Piano")),
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                    new Telegram("CharlotteO"), new Event("Charity Gala"), new Role("Chairman"),
                     getSkillSet("JavaScript")),
            new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                    new Telegram("livelyDavid"), new Event("Night Cycling"), new Role("Organiser"),
                     getSkillSet("Drumming")),
            new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                    new Telegram("RealIrfanI"), new Event("NUS Marathon"), new Role("Programmes Head"),
                     getSkillSet("JavaScript")),
            new Person(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                    new Telegram("Balakrishnan_Roy"), new Event("Exam Welfare Pack"), new Role("Project Director"),
                    getSkillSet("JavaScript"))
        };
    }
