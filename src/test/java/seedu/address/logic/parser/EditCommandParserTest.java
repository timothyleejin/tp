...
public class EditCommandParserTest {
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + SKILL_DESC_HUSBAND
                + EMAIL_DESC_AMY + TELEGRAM_DESC_AMY + NAME_DESC_AMY + SKILL_DESC_FRIEND;
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + TELEGRAM_DESC_AMY + EMAIL_DESC_AMY
                + SKILL_DESC_FRIEND + PHONE_DESC_AMY + TELEGRAM_DESC_AMY + EMAIL_DESC_AMY + SKILL_DESC_FRIEND
                + PHONE_DESC_BOB + TELEGRAM_DESC_BOB + EMAIL_DESC_BOB + SKILL_DESC_HUSBAND;
