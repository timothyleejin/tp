...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Person expectedPerson = new PersonBuilder(BOB).withSkills(VALID_SKILL_FRIEND).build();

        // whitespace only preamble
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + TELEGRAM_DESC_BOB + ROLE_DESC_BOB + EVENT_DESC_BOB + SKILL_DESC_FRIEND,
                new AddCommand(expectedPerson));


        // multiple skills - all accepted
        Person expectedPersonMultipleSkills = new PersonBuilder(BOB).withSkills(VALID_SKILL_FRIEND, VALID_SKILL_HUSBAND)
                .build();
        assertParseSuccess(parser,
                NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + TELEGRAM_DESC_BOB + ROLE_DESC_BOB
                        + EVENT_DESC_BOB + SKILL_DESC_HUSBAND + SKILL_DESC_FRIEND,
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + TELEGRAM_DESC_AMY
                + ROLE_DESC_AMY + EVENT_DESC_AMY, new AddCommand(expectedPerson));
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + TELEGRAM_DESC_BOB
                + ROLE_DESC_BOB + EVENT_DESC_BOB + SKILL_DESC_HUSBAND + SKILL_DESC_FRIEND, Name.MESSAGE_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_PHONE_DESC + EMAIL_DESC_BOB + TELEGRAM_DESC_BOB
                + ROLE_DESC_BOB + EVENT_DESC_BOB + SKILL_DESC_HUSBAND + SKILL_DESC_FRIEND, Phone.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + INVALID_EMAIL_DESC + TELEGRAM_DESC_BOB
                + ROLE_DESC_BOB + EVENT_DESC_BOB + SKILL_DESC_HUSBAND + SKILL_DESC_FRIEND, Email.MESSAGE_CONSTRAINTS);

        // invalid telegram
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + INVALID_TELEGRAM_DESC + ROLE_DESC_BOB + EVENT_DESC_BOB + SKILL_DESC_HUSBAND
                        + SKILL_DESC_FRIEND, Telegram.MESSAGE_CONSTRAINTS);

        // invalid skill
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + TELEGRAM_DESC_BOB
                + ROLE_DESC_BOB + EVENT_DESC_BOB + INVALID_SKILL_DESC + VALID_SKILL_FRIEND, Skill.MESSAGE_CONSTRAINTS);
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                        + TELEGRAM_DESC_BOB + ROLE_DESC_BOB + EVENT_DESC_BOB + SKILL_DESC_HUSBAND + SKILL_DESC_FRIEND,
