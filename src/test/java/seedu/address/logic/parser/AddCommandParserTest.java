...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + ROLE_DESC_BOB + EVENT_DESC_BOB + SKILL_DESC_FRIEND,
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC
                + ROLE_DESC_BOB + EVENT_DESC_BOB + SKILL_DESC_HUSBAND + SKILL_DESC_FRIEND, Address.MESSAGE_CONSTRAINTS);
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                        + ADDRESS_DESC_BOB + ROLE_DESC_BOB + EVENT_DESC_BOB + SKILL_DESC_HUSBAND + SKILL_DESC_FRIEND,
