...
**Favourite**: <br> Add a contact to favourites | `favourite INDEX` or <br> `fav INDEX`<br> <br> e.g. `fav 3`
**Unfavourite**: <br> Remove a contact from favourites | `unfavourite INDEX` or <br> `unfav INDEX`<br> <br> e.g. `unfav 3`
